...
#Funciona de la misma manera, le damos ordenes y el celular tiene predeterminado qué 
# acciones hacer según lo que le pidamos 

#Desafio II
#El prompt en mi caso es % 
#la terminal de visual code entiende como lenguaje Python

#Para pensar 🤔:¿Cuál es el resultado? ¿Qué significa entonces el *?
#El resultado es 15 
#El * significa multiplicacion

#Para pensar 🤔:¿Cuál es el resultado? ¿Qué significa entonces el /?
#El resultado es 2 
#El / significa dividir

edad_lola = 13
edad_ana = 32
edad_lola == edad_ana
#Para pensar 🤔:¿Cuál es el resultado? ¿Qué tipo de dato es?
#El resultado es False y es un booleano
...
#Nos da 'Hola terricolas'. Sigue siendo un string solo que es mas largo que el anterior.
...
#No va a encontrar el numero 25 porque lo agregamos a la lista y despues lo sacamos. 
#El index nos sirve para ver en que posicion se encuentra lo que estamos buscando
